...
mod tests {
    ...
    fn parse_empty_object() {
        ...
        assert_eq!(json.get_next_element(&mut root_object), None);
    }
    ...
    fn parse_empty_array() {
        ...
        assert_eq!(json.get_next_element(&mut root_array), None);
    }
    ...
    fn parse_pairs_test() {
        ...
        if let Some((b"pairs", value)) = json.get_next_element(&mut root_object) {
            let mut pairs_array = json.open_collection(value);
            if let Some((_, value)) = json.get_next_element(&mut pairs_array) {
                let mut pair_object = json.open_collection(value);
